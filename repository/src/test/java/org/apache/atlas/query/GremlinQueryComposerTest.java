...
public class GremlinQueryComposerTest {
    ...
    public void whereClauseTextContains() {
        ...
        verify("AtlasServer where AtlasServer.name like \"Tab*\"",
          "g.V().has('__typeName', 'Table').has('AtlasServer.name', org.janusgraph.core.attribute.Text.textContainsRegex(\"Tab.*\")).dedup().limit(25).toList()");
